...
namespace VCI.XmlEditor.Document
{
	...
	public class FoldMarker : AbstractSegment, IComparable // ,
	{
		...
		static void GetPointForOffset(XmlDocument document, int offset, out int line, out int column)
		{
		...
		public FoldMarker(XmlDocument document, int offset, int length, string foldText, bool isFolded)
		{
		...
		public FoldMarker(XmlDocument document, int startLine, int startColumn, int endLine, int endColumn)
			: this(document, startLine, startColumn, endLine, endColumn, FoldType.Unspecified)
		{
		}

		public FoldMarker(XmlDocument document, int startLine, int startColumn, int endLine, int endColumn, FoldType foldType)
			: this(document, startLine, startColumn, endLine, endColumn, foldType, "...")
		{
		}

		public FoldMarker(XmlDocument document, int startLine, int startColumn, int endLine, int endColumn, FoldType foldType, string foldText)
			: this(document, startLine, startColumn, endLine, endColumn, foldType, foldText, false)
		{
		}

		public FoldMarker(XmlDocument document, int startLine, int startColumn, int endLine, int endColumn, FoldType foldType, string foldText, bool isFolded)
		{
			this.document = document;

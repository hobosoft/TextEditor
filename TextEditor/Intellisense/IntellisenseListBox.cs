...
namespace TextEditor.Intellisense
{
    public partial class IntellisenseListBox : ListBox
    {
        ...
        public void AddItem(IntellisenseListItem imageListItem)
        {
            this.Items.Add(imageListItem);
        }
        public void RemoveItem(IntellisenseListItem imageListItem)
        {
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            else
            {
                ...
                if (this.Items[e.Index].GetType() == typeof(IntellisenseListItem))
                {

                    // get item to draw
                    IntellisenseListItem item = (IntellisenseListItem)this.Items[e.Index];

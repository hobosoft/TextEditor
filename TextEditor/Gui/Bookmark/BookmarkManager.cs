...
namespace TextEditor.Document
{
	...
	{
		Bookmark CreateBookmark(TextBoxControl ctrl, TextLocation location);
	}
	...
	public class BookmarkManager
	{
		...
		public TextBoxControl Document {
			get {
				return _control;
			}
		}
		...
		/// </summary>
		internal BookmarkManager(TextBoxControl ctrl)
		{
			this._control = ctrl;
		}
		...
		public void ToggleMarkAt(TextLocation location)
		{
			Bookmark newMark;
			if (Factory != null) {
				newMark = Factory.CreateBookmark(_control, location);
			} else {
				newMark = new Bookmark(_control, location);
			}

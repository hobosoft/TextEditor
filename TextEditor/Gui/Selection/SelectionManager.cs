	...
	public class SelectionManager : IDisposable
	{
		...
		public bool SelectionIsReadonly
		{
			get
			{
				...
				{
					if (SelectionIsReadOnly(textArea, sel))
						return true;
				}
				return false;
			}
		...
		void EditorChanged(object sender, EditorEventArgs e)
		{
			if (e.Text == null)
			{
		...
		public void ClearSelection()
		{
			...
			//ClearWithoutUpdate();
			//document.CommitUpdate();
			selectionStart = new TextLocation(-1,-1);
			selectionEnd = new TextLocation(-1,-1);
		}

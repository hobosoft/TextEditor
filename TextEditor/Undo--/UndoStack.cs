...
namespace VCI.XmlEditor.Undo
{
	...
	public class UndoStack
	{
		...
		public XmlEditorControl TextEditorControl = null;
		...
		public void Push(IUndoableOperation operation)
		{
			...
			if (AcceptChanges) {
				...
				if (TextEditorControl != null) {
					undostack.Push(new UndoableSetCaretPosition(this, TextEditorControl.Caret.Position));
					actionCountInUndoGroup++;
				}
				EndUndoGroup();
				ClearRedoStack();

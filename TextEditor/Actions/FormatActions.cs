...
namespace VCI.XmlEditor.Actions
{
	...
	{
		protected XmlEditorControl editor;
		abstract protected void Convert(XmlDocument document, int startLine, int endLine);
	...
	{
		protected XmlEditorControl editor;
		abstract protected void Convert(XmlDocument document, int offset, int length);
	...
	{
		protected override void Convert(XmlDocument document, int y1, int y2)
		{
			for (int i = y1; i < y2; ++i) {
	...
	{
		protected override void Convert(XmlDocument document, int startOffset, int length)
		{
	...
	{
		protected override void Convert(XmlDocument document, int startLine, int endLine)
		{
